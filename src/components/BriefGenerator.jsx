    ...
    <div className="animate-fade-in">
      ...
      <div className="max-w-2xl mx-auto">
        <form
          ...
          className="bg-slate-800/60 backdrop-blur border border-slate-700 rounded-3xl p-8 shadow-2xl"
        >
          <h2 className="text-white font-bold text-xl mb-6 flex items-center gap-2">
            <span className="w-7 h-7 bg-teal-500 rounded-lg flex items-center justify-center text-sm">
              1
            </span>
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {DEMO_EXAMPLES.map((ex) => (
              <button
                ...
                className="bg-slate-800/60 border border-slate-700 hover:border-teal-500/50 hover:bg-slate-700/60 text-white/80 hover:text-white px-4 py-2 rounded-xl text-sm transition-all"
              >
                {ex.company}
              </button>
            ))}
          ...
          {[
            {
              ...
              step: "1",
              title: "AI Searches",
              desc: "Fetches real news from last 30 days + financial data",
            },
            {
              icon: "🤖",
              step: "2",
            ...
            },
            {
              ...
              step: "3",
              title: "You Get Ready",
              desc: "Read in 60 seconds. Walk in knowing everything.",
            },
